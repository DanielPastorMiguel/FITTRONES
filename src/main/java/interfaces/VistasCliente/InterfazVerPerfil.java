...
public class InterfazVerPerfil extends javax.swing.JFrame {
    ...
    public InterfazVerPerfil(JFrame principal) {
        initComponents();
    ...
    private void inicializarComponentes(){
        if (app.getUsuarioLogueado().getClass() == Cliente.class) jButtonVerServicios.setVisible(false);
        else jButtonVerServicios.setVisible(true);
    }
    ...
    private void jButtonVerServiciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerServiciosActionPerformed
        new InterfazServiciosAdquiridos(this).setVisible(true);
