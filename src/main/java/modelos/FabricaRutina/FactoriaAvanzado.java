...
public class FactoriaAvanzado extends FabricaRutina {
    ...
    public Rutina crearEjercicios() {
        ...
        for (String nombreEj : listaEjerciciosEmpuje) {
            ejerciciosEmpuje.add(new Ejercicio(nombreEj, 12, 4, utiles.Enum.EjercicioEnum.EMPUJE));
        }
        for (String nombreEj : listaEjerciciosTiron) {
            ejerciciosTiron.add(new Ejercicio(nombreEj, 12, 4, utiles.Enum.EjercicioEnum.TIRON));
        }
        for (String nombreEj : listaEjerciciosPierna) {
            ejerciciosPierna.add(new Ejercicio(nombreEj, 12, 4, utiles.Enum.EjercicioEnum.PIERNA));
        }
